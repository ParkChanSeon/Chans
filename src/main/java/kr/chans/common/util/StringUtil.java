...
public class StringUtil {
	...
	public static boolean isNull(String str, boolean withTrim) {
		...
		if (!result && withTrim) {
			result = (str.trim().length() == 0 || str.trim().isEmpty()) ? true : false;
		}
		return result;
	}
	...
	public static Integer parseInt(Object obj, Integer defaultInt) {
		Integer res = defaultInt;
		try {
